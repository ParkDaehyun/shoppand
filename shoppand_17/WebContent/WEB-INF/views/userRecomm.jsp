...
<html>
 <head>
    ...
    <body>
		...
		<div class="parallax" style="background-image: url(images/bggi3.jpg);">
			
			<div class="text">
				<h1>${sessionScope.userInfo.name}님을 위한</h1>
				<p>추천 게시물</p>
			</div>
		</div>
		...
		<section class="text-block">
			...
			<div class="dark-bg">
				<div class="container">
					...
					<h2>추천 게시물 <small class="color">/ 회원님과 다른회원님이 추천한 게시글들의 관계를 바탕으로 새로운 게시물을 추천합니다. </small></h2>
					<p>회원님과 유사한 취향의 사용자들은 아래의 게시글들을 좋아합니다.</p>
